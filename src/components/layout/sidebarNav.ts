...
export const navItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
        { label: 'Orders', href: '/b2c', icon: ShoppingBag },
        { label: 'E-Commerce Import', href: '/b2c/import', icon: Upload },
        { label: 'Order Sync', href: '/b2c/sync', icon: Repeat },
        { label: 'Allocation', href: '/b2c/allocation', icon: Boxes },
        { label: 'Wave Picking', href: '/b2c/waves', icon: Layers },
        { label: 'Batch Picking', href: '/b2c/batch-picking', icon: ClipboardList },
        { label: 'Single-Order Picking', href: '/b2c/single-picking', icon: ClipboardCheck },
        { label: 'Packing', href: '/b2c/packing', icon: PackageCheck },
        { label: 'Shipping Labels', href: '/b2c/shipping-labels', icon: Printer },
        { label: 'Tracking', href: '/b2c/tracking', icon: Route },
        { label: 'COD', href: '/b2c/cod', icon: WalletCards },
        { label: 'RTO', href: '/b2c/rto', icon: Truck },
        { label: 'Returns', href: '/b2c/returns', icon: ArchiveX },
    ],
  },
  {
