...
export function CreateWaveModal({ open, onOpenChange }: { open: boolean; onOpenChange: (open: boolean) => void }) {
  ...
  async function handleSubmit() {
    ...
    setSubmitting(true);
    try {
      const wave = waveService.createWave({ name, warehouseId, priority, cutoffTime, orderIds: selected });
      ...
      <DialogContent className="max-w-lg">
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          <div className="space-y-1">
            ...
            <Select value={warehouseId} onValueChange={(v) => { setWarehouseId(v); setSelected([]); }}>
        ...
        <div className="space-y-1">
          ...
          {!warehouseId ? (
            ...
            <p className="text-xs text-amber-600">No allocated orders without a wave for this warehouse yet.</p>
          ) : (
